...
- [geminiMediaDefinition](variables/geminiMediaDefinition.md)
...
- [openaiImagesDefinition](variables/openaiImagesDefinition.md)
...
- [twitterDefinition](variables/twitterDefinition.md)
